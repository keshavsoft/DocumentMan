...
import { FetchPost as UpdateFuncsFetchPost } from "./UpdateFuncs.js";
...
let jFAddListeners = () => {
    ...
    let jVarLocalPageUpdate = document.getElementById("PageUpdate");
    jVarLocalPageUpdate.addEventListener("click", UpdateFuncsFetchPost);
};
